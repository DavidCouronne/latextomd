...
parser = argparse.ArgumentParser(
    description="""Basic usage: latextomd input.tex -o output.md"""
)
...
parser.add_argument(
    "--mkdocs",
    action="store_true",
    help="mkdocs admonition",
)
parser.add_argument(
    "--docusaurus",
    action="store_true",
    help="docusaurus admonition",
)
...
def main():
    options = {
        ...
        "mkdocs": args.mkdocs,
        "docusaurus": args.docusaurus,
    }

    if ".tex" not in args.filename:
        print("""input file path must be a .tex file""")
        sys.exit(2)
    ...
    markdown_string = latextomd.to_markdown(latex_string, export_file, options)
